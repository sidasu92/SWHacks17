...
/**
 * Created by Ashish on 10/29/2016.
 */
...
public class DataParser {
    ...
    public List<List<HashMap<String,String>>> parse(JSONObject jObject){
        ...
        try {
            ...
            System.out.println("Distance :"+jsondistance.getString("text"));
            System.out.println("Duration :"+jsonduration.getString("text"));
            List tripdetails = new ArrayList<>();
            HashMap<String, String> hm1 = new HashMap<>();
            hm1.put("distance",jsondistance.getString("text"));
            hm1.put("time",jsonduration.getString("text"));
            tripdetails.add(hm1);
